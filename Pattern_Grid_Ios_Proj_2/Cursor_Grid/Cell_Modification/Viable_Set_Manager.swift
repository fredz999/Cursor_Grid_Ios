...
class Viable_Set_Manager {
    ...
    func nil_Viable_Set(){
        ...
        if lineCellsOptional != nil{lineCellsOptional = nil}
        if currentLowestViableCell_X_Index != nil{ currentLowestViableCell_X_Index = nil }
        if currentHighestViableCell_X_Index != nil{ currentHighestViableCell_X_Index = nil }
        if all_The_Cells_Of_The_Locked_Line != nil{ all_The_Cells_Of_The_Locked_Line = nil }
        ...
        if currentViableDataCellArray.count > 0 {
            for cell in currentViableDataCellArray {
                if cell.note_Status == .potentialSingle { cell.note_Status = .confirmedSingle }
                if cell.place_In_Viable_Set != nil { cell.place_In_Viable_Set = nil }
                if cell.viable_Group_Status == .in_A_Write_Viable_Group{ cell.viable_Group_Status = .not_In_A_Write_Viable_Group }
                cell.repaint_Cell()
            }
        }
